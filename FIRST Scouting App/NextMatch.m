...
- (IBAction)red1FinishedEditing:(id)sender {
    ...
    if (_red1SearchBox.text.length > 0) {
        ...
        if (red1TeamArray.count == 0) {
            ...
            _red1AutoHighMakes.text = [[NSString alloc] initWithFormat:@"%.0f/%.0f", team.autoHighMakesAvgCalculated, team.autoHighAttemptsAvgCalculated];
            _red1AutoHighHot.text = [[NSString alloc] initWithFormat:@"%.0f%%", team.autoHighHotPercentageCalculated];
            _red1AutoLowMakes.text = [[NSString alloc] initWithFormat:@"%.0f/%.0f", team.autoLowMakesAvgCalculated, team.autoLowAttemptsAvgCalculated];
            _red1AutoLowHot.text = [[NSString alloc] initWithFormat:@"%.0f%%", team.autoLowHotPercentageCalculated];
            _red1MobilityPercentage.text = [[NSString alloc] initWithFormat:@"%.0f%%", team.mobilityBonusPercentageCalculated];
            _red1TeleopHighMakes.text = [[NSString alloc] initWithFormat:@"%.0f/%.0f", team.teleopHighMakeAvgCalculated, team.teleopHighAttemptsAvgCalculated];
            _red1TeleopLowMakes.text = [[NSString alloc] initWithFormat:@"%.0f/%.0f", team.teleopLowMakeAvgCalculated, team.teleopLowAttemptsAvgCalculated];
            _red1TrussShot.text = [[NSString alloc] initWithFormat:@"%.1f", team.teleopOverAvgCalculated];
            _red1TrussCatch.text = [[NSString alloc] initWithFormat:@"%.1f", team.teleopCatchAvgCalculated];
            _red1Passes.text = [[NSString alloc] initWithFormat:@"%.1f", team.teleopPassedAvgCalculated];
            _red1Receives.text = [[NSString alloc] initWithFormat:@"%.1f", team.teleopReceivedAvgCalculated];
            _red1SmallPenalty.text = [[NSString alloc] initWithFormat:@"%.0f", team.smallPenaltyAvgCalculated];
            _red1LargePenalty.text = [[NSString alloc] initWithFormat:@"%.0f", team.largePenaltyAvgCalculated];
            _red1Offensive.text = [[NSString alloc] initWithFormat:@"%.0f%%", team.offensiveZonePercentageCalculated];
            _red1Neutral.text = [[NSString alloc] initWithFormat:@"%.0f%%", team.neutralZonePercentageCalculated];
            _red1Defensive.text = [[NSString alloc] initWithFormat:@"%.0f%%", team.defensiveZonePercentageCalculated];
...
- (IBAction)red2FinishedEditing:(id)sender {
    ...
    if (_red2SearchBox.text.length > 0) {
        ...
        if (red2TeamArray.count == 0) {
            ...
            _red2AutoHighMakes.text = [[NSString alloc] initWithFormat:@"%.0f/%.0f", team.autoHighMakesAvgCalculated, team.autoHighAttemptsAvgCalculated];
            _red2AutoHighHot.text = [[NSString alloc] initWithFormat:@"%.0f%%", team.autoHighHotPercentageCalculated];
            _red2AutoLowMakes.text = [[NSString alloc] initWithFormat:@"%.0f/%.0f", team.autoLowMakesAvgCalculated, team.autoLowAttemptsAvgCalculated];
            _red2AutoLowHot.text = [[NSString alloc] initWithFormat:@"%.0f%%", team.autoLowHotPercentageCalculated];
            _red2MobilityPercentage.text = [[NSString alloc] initWithFormat:@"%.0f%%", team.mobilityBonusPercentageCalculated];
            _red2TeleopHighMakes.text = [[NSString alloc] initWithFormat:@"%.0f/%.0f", team.teleopHighMakeAvgCalculated, team.teleopHighAttemptsAvgCalculated];
            _red2TeleopLowMakes.text = [[NSString alloc] initWithFormat:@"%.0f/%.0f", team.teleopLowMakeAvgCalculated, team.teleopLowAttemptsAvgCalculated];
            _red2TrussShot.text = [[NSString alloc] initWithFormat:@"%.1f", team.teleopOverAvgCalculated];
            _red2TrussCatch.text = [[NSString alloc] initWithFormat:@"%.1f", team.teleopCatchAvgCalculated];
            _red2Passes.text = [[NSString alloc] initWithFormat:@"%.1f", team.teleopPassedAvgCalculated];
            _red2Receives.text = [[NSString alloc] initWithFormat:@"%.1f", team.teleopReceivedAvgCalculated];
            _red2SmallPenalty.text = [[NSString alloc] initWithFormat:@"%.0f", team.smallPenaltyAvgCalculated];
            _red2LargePenalty.text = [[NSString alloc] initWithFormat:@"%.0f", team.largePenaltyAvgCalculated];
            _red2Offensive.text = [[NSString alloc] initWithFormat:@"%.0f%%", team.offensiveZonePercentageCalculated];
            _red2Neutral.text = [[NSString alloc] initWithFormat:@"%.0f%%", team.neutralZonePercentageCalculated];
            _red2Defensive.text = [[NSString alloc] initWithFormat:@"%.0f%%", team.defensiveZonePercentageCalculated];
...
- (IBAction)red3FinishedEditing:(id)sender {
    ...
    if (_red3SearchBox.text.length > 0) {
        ...
        if (red3TeamArray.count == 0) {
            ...
            _red3AutoHighMakes.text = [[NSString alloc] initWithFormat:@"%.0f/%.0f", team.autoHighMakesAvgCalculated, team.autoHighAttemptsAvgCalculated];
            _red3AutoHighHot.text = [[NSString alloc] initWithFormat:@"%.0f%%", team.autoHighHotPercentageCalculated];
            _red3AutoLowMakes.text = [[NSString alloc] initWithFormat:@"%.0f/%.0f", team.autoLowMakesAvgCalculated, team.autoLowAttemptsAvgCalculated];
            _red3AutoLowHot.text = [[NSString alloc] initWithFormat:@"%.0f%%", team.autoLowHotPercentageCalculated];
            _red3MobilityPercentage.text = [[NSString alloc] initWithFormat:@"%.0f%%", team.mobilityBonusPercentageCalculated];
            _red3TeleopHighMakes.text = [[NSString alloc] initWithFormat:@"%.0f/%.0f", team.teleopHighMakeAvgCalculated, team.teleopHighAttemptsAvgCalculated];
            _red3TeleopLowMakes.text = [[NSString alloc] initWithFormat:@"%.0f/%.0f", team.teleopLowMakeAvgCalculated, team.teleopLowAttemptsAvgCalculated];
            _red3TrussShot.text = [[NSString alloc] initWithFormat:@"%.1f", team.teleopOverAvgCalculated];
            _red3TrussCatch.text = [[NSString alloc] initWithFormat:@"%.1f", team.teleopCatchAvgCalculated];
            _red3Passes.text = [[NSString alloc] initWithFormat:@"%.1f", team.teleopPassedAvgCalculated];
            _red3Receives.text = [[NSString alloc] initWithFormat:@"%.1f", team.teleopReceivedAvgCalculated];
            _red3SmallPenalty.text = [[NSString alloc] initWithFormat:@"%.0f", team.smallPenaltyAvgCalculated];
            _red3LargePenalty.text = [[NSString alloc] initWithFormat:@"%.0f", team.largePenaltyAvgCalculated];
            _red3Offensive.text = [[NSString alloc] initWithFormat:@"%.0f%%", team.offensiveZonePercentageCalculated];
            _red3Neutral.text = [[NSString alloc] initWithFormat:@"%.0f%%", team.neutralZonePercentageCalculated];
            _red3Defensive.text = [[NSString alloc] initWithFormat:@"%.0f%%", team.defensiveZonePercentageCalculated];
...
- (IBAction)blue1FinishedEditing:(id)sender {
    ...
    if (_blue1SearchBox.text.length > 0) {
        ...
        if (blue1TeamArray.count == 0) {
            ...
            _blue1AutoHighMakes.text = [[NSString alloc] initWithFormat:@"%.0f/%.0f", team.autoHighMakesAvgCalculated, team.autoHighAttemptsAvgCalculated];
            _blue1AutoHighHot.text = [[NSString alloc] initWithFormat:@"%.0f%%", team.autoHighHotPercentageCalculated];
            _blue1AutoLowMakes.text = [[NSString alloc] initWithFormat:@"%.0f/%.0f", team.autoLowMakesAvgCalculated, team.autoLowAttemptsAvgCalculated];
            _blue1AutoLowHot.text = [[NSString alloc] initWithFormat:@"%.0f%%", team.autoLowHotPercentageCalculated];
            _blue1MobilityPercentage.text = [[NSString alloc] initWithFormat:@"%.0f%%", team.mobilityBonusPercentageCalculated];
            _blue1TeleopHighMakes.text = [[NSString alloc] initWithFormat:@"%.0f/%.0f", team.teleopHighMakeAvgCalculated, team.teleopHighAttemptsAvgCalculated];
            _blue1TeleopLowMakes.text = [[NSString alloc] initWithFormat:@"%.0f/%.0f", team.teleopLowMakeAvgCalculated, team.teleopLowAttemptsAvgCalculated];
            _blue1TrussShot.text = [[NSString alloc] initWithFormat:@"%.1f", team.teleopOverAvgCalculated];
            _blue1TrussCatch.text = [[NSString alloc] initWithFormat:@"%.1f", team.teleopCatchAvgCalculated];
            _blue1Passes.text = [[NSString alloc] initWithFormat:@"%.1f", team.teleopPassedAvgCalculated];
            _blue1Receives.text = [[NSString alloc] initWithFormat:@"%.1f", team.teleopReceivedAvgCalculated];
            _blue1SmallPenalty.text = [[NSString alloc] initWithFormat:@"%.0f", team.smallPenaltyAvgCalculated];
            _blue1LargePenalty.text = [[NSString alloc] initWithFormat:@"%.0f", team.largePenaltyAvgCalculated];
            _blue1Offensive.text = [[NSString alloc] initWithFormat:@"%.0f%%", team.offensiveZonePercentageCalculated];
            _blue1Neutral.text = [[NSString alloc] initWithFormat:@"%.0f%%", team.neutralZonePercentageCalculated];
            _blue1Defensive.text = [[NSString alloc] initWithFormat:@"%.0f%%", team.defensiveZonePercentageCalculated];
...
- (IBAction)blue2FinishedEditing:(id)sender {
    ...
    if (_blue2SearchBox.text.length > 0) {
        ...
        if (blue2TeamArray.count == 0) {
            ...
            _blue2AutoHighMakes.text = [[NSString alloc] initWithFormat:@"%.0f/%.0f", team.autoHighMakesAvgCalculated, team.autoHighAttemptsAvgCalculated];
            _blue2AutoHighHot.text = [[NSString alloc] initWithFormat:@"%.0f%%", team.autoHighHotPercentageCalculated];
            _blue2AutoLowMakes.text = [[NSString alloc] initWithFormat:@"%.0f/%.0f", team.autoLowMakesAvgCalculated, team.autoLowAttemptsAvgCalculated];
            _blue2AutoLowHot.text = [[NSString alloc] initWithFormat:@"%.0f%%", team.autoLowHotPercentageCalculated];
            _blue2MobilityPercentage.text = [[NSString alloc] initWithFormat:@"%.0f%%", team.mobilityBonusPercentageCalculated];
            _blue2TeleopHighMakes.text = [[NSString alloc] initWithFormat:@"%.0f/%.0f", team.teleopHighMakeAvgCalculated, team.teleopHighAttemptsAvgCalculated];
            _blue2TeleopLowMakes.text = [[NSString alloc] initWithFormat:@"%.0f/%.0f", team.teleopLowMakeAvgCalculated, team.teleopLowAttemptsAvgCalculated];
            _blue2TrussShot.text = [[NSString alloc] initWithFormat:@"%.1f", team.teleopOverAvgCalculated];
            _blue2TrussCatch.text = [[NSString alloc] initWithFormat:@"%.1f", team.teleopCatchAvgCalculated];
            _blue2Passes.text = [[NSString alloc] initWithFormat:@"%.1f", team.teleopPassedAvgCalculated];
            _blue2Receives.text = [[NSString alloc] initWithFormat:@"%.1f", team.teleopReceivedAvgCalculated];
            _blue2SmallPenalty.text = [[NSString alloc] initWithFormat:@"%.0f", team.smallPenaltyAvgCalculated];
            _blue2LargePenalty.text = [[NSString alloc] initWithFormat:@"%.0f", team.largePenaltyAvgCalculated];
            _blue2Offensive.text = [[NSString alloc] initWithFormat:@"%.0f%%", team.offensiveZonePercentageCalculated];
            _blue2Neutral.text = [[NSString alloc] initWithFormat:@"%.0f%%", team.neutralZonePercentageCalculated];
            _blue2Defensive.text = [[NSString alloc] initWithFormat:@"%.0f%%", team.defensiveZonePercentageCalculated];
...
- (IBAction)blue3FinishedEditing:(id)sender {
    ...
    if (_blue3SearchBox.text.length > 0) {
        ...
        if (blue3TeamArray.count == 0) {
            ...
            _blue3AutoHighMakes.text = [[NSString alloc] initWithFormat:@"%.0f/%.0f", team.autoHighMakesAvgCalculated, team.autoHighAttemptsAvgCalculated];
            _blue3AutoHighHot.text = [[NSString alloc] initWithFormat:@"%.0f%%", team.autoHighHotPercentageCalculated];
            _blue3AutoLowMakes.text = [[NSString alloc] initWithFormat:@"%.0f/%.0f", team.autoLowMakesAvgCalculated, team.autoLowAttemptsAvgCalculated];
            _blue3AutoLowHot.text = [[NSString alloc] initWithFormat:@"%.0f%%", team.autoLowHotPercentageCalculated];
            _blue3MobilityPercentage.text = [[NSString alloc] initWithFormat:@"%.0f%%", team.mobilityBonusPercentageCalculated];
            _blue3TeleopHighMakes.text = [[NSString alloc] initWithFormat:@"%.0f/%.0f", team.teleopHighMakeAvgCalculated, team.teleopHighAttemptsAvgCalculated];
            _blue3TeleopLowMakes.text = [[NSString alloc] initWithFormat:@"%.0f/%.0f", team.teleopLowMakeAvgCalculated, team.teleopLowAttemptsAvgCalculated];
            _blue3TrussShot.text = [[NSString alloc] initWithFormat:@"%.1f", team.teleopOverAvgCalculated];
            _blue3TrussCatch.text = [[NSString alloc] initWithFormat:@"%.1f", team.teleopCatchAvgCalculated];
            _blue3Passes.text = [[NSString alloc] initWithFormat:@"%.1f", team.teleopPassedAvgCalculated];
            _blue3Receives.text = [[NSString alloc] initWithFormat:@"%.1f", team.teleopReceivedAvgCalculated];
            _blue3SmallPenalty.text = [[NSString alloc] initWithFormat:@"%.0f", team.smallPenaltyAvgCalculated];
            _blue3LargePenalty.text = [[NSString alloc] initWithFormat:@"%.0f", team.largePenaltyAvgCalculated];
            _blue3Offensive.text = [[NSString alloc] initWithFormat:@"%.0f%%", team.offensiveZonePercentageCalculated];
            _blue3Neutral.text = [[NSString alloc] initWithFormat:@"%.0f%%", team.neutralZonePercentageCalculated];
            _blue3Defensive.text = [[NSString alloc] initWithFormat:@"%.0f%%", team.defensiveZonePercentageCalculated];
