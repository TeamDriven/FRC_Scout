...
@implementation RankingsCDTVC

-(void)setManagedObjectContext:(NSManagedObjectContext *)managedObjectContext{
    _managedObjectContext = managedObjectContext;
    
    NSFetchRequest *allTeamsRequest = [[NSFetchRequest alloc] initWithEntityName:@"Team"];
    allTeamsRequest.predicate = [NSPredicate predicateWithFormat:@"regionalIn.name = %@", _regionalSelected];
    allTeamsRequest.sortDescriptors = @[[NSSortDescriptor sortDescriptorWithKey:_sortString ascending:NO], [NSSortDescriptor sortDescriptorWithKey:@"totalPointsAvg" ascending:NO]];
    
    self.fetchedResultsController = [[NSFetchedResultsController alloc]
                                     initWithFetchRequest:allTeamsRequest
...
-(void)sortOrderSmallFirst{
    NSFetchRequest *allTeamsRequest = [[NSFetchRequest alloc] initWithEntityName:@"Team"];
    allTeamsRequest.predicate = [NSPredicate predicateWithFormat:@"regionalIn.name = %@", _regionalSelected];
    allTeamsRequest.sortDescriptors = @[[NSSortDescriptor sortDescriptorWithKey:_sortString ascending:YES], [NSSortDescriptor sortDescriptorWithKey:@"totalPointsAvg" ascending:NO]];
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    RankingsCell *cell = (RankingsCell *)[tableView dequeueReusableCellWithIdentifier:@"rankingsCell"];
    
    Team *tm = [self.fetchedResultsController objectAtIndexPath:indexPath];
    
    cell.rankLbl.text = [[NSString alloc] initWithFormat:@"#%ld", (long)indexPath.row+1];
    
    cell.teamNumLbl.text = [[NSString alloc] initWithFormat:@"%@", tm.name];
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    teamChosen = [self.fetchedResultsController objectAtIndexPath:indexPath];
    ...
    gruayOutView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, 768, 1024)];
    gruayOutView.backgroundColor = [UIColor colorWithWhite:0.5 alpha:0.5];
    [[[self.view superview] superview] addSubview:gruayOutView];
    
    listSelectorView = [[UIView alloc] initWithFrame:CGRectMake(109, 175, 550, 560)];
    listSelectorView.backgroundColor = [UIColor whiteColor];
    listSelectorView.layer.cornerRadius = 10;
    [gruayOutView addSubview:listSelectorView];
    
    closeButton = [UIButton buttonWithType:UIButtonTypeSystem];
    closeButton.frame = CGRectMake(485, 0, 60, 35);
    ...
    titleLbl = [[UILabel alloc] initWithFrame:CGRectMake(225, 15, 100, 30)];
    titleLbl.textAlignment = NSTextAlignmentCenter;
    titleLbl.font = [UIFont fontWithName:@"Futura-CondensedExtraBold" size:24];
    titleLbl.text = teamChosen.name;
    
    averagesBox = [[UIView alloc] initWithFrame:CGRectMake(323, 50, 180, 160)];
    averagesBox.backgroundColor = [UIColor colorWithWhite:0.9 alpha:1.0];
    averagesBox.layer.cornerRadius = 10;
    
    UILabel *averagesBoxTitleLbl = [[UILabel alloc] initWithFrame:CGRectMake(15, 7, 100, 18)];
    ...
    autonomousAvgValue.text = [[NSString alloc] initWithFormat:@"%.1f", teamChosen.autonomousAvgCalculated];
    ...
    teleopAvgValue.text = [[NSString alloc] initWithFormat:@"%.1f", teamChosen.teleopAvgCalculated];
    ...
    passesAvgValue.text = [[NSString alloc] initWithFormat:@"%.1f", teamChosen.teleopPassedAvgCalculated];
    ...
    receivesAvgValue.text = [[NSString alloc] initWithFormat:@"%.1f", teamChosen.teleopReceivedAvgCalculated];
    ...
    overTrussAvgValue.text = [[NSString alloc] initWithFormat:@"%.1f", teamChosen.teleopOverAvgCalculated];
    ...
    trussCatchAvgValue.text = [[NSString alloc] initWithFormat:@"%.1f", teamChosen.teleopCatchAvgCalculated];
    ...
    pitDataBtn.frame = CGRectMake(118, 215, 100, 20);
    ...
    robotPic = [[UIImageView alloc] initWithFrame:CGRectMake(58, 50, 160, 160)];
    robotPic.image = [UIImage imageWithData:teamChosen.master.pitTeam.image];
    ...
    tableViewLbl = [[UILabel alloc] initWithFrame:CGRectMake(225, 230, 100, 15)];
    ...
    matchesTableView = [[UITableView alloc] initWithFrame:CGRectMake(35, 250, 480, 295) style:UITableViewStylePlain];
    ...
    [teamMatchesCDTVC setTeamSelected:teamChosen];
    ...
    [UIView animateWithDuration:0.2 animations:^{
        listSelectorView.frame = CGRectMake(109, 175, 550, 560);
...
-(void)closeListSelectorView{
    ...
    [UIView animateWithDuration:0.2 animations:^{
        ...
        [gruayOutView removeFromSuperview];
        teamChosen = nil;
    }];
}
...
-(void)openPitData{
    PitTeam *ptSelected = teamChosen.master.pitTeam;
