...
-(void)setManagedObjectContext:(NSManagedObjectContext *)managedObjectContext{
    ...
    NSFetchRequest *masterTeamRequest = [[NSFetchRequest alloc] initWithEntityName:@"Match"];
    masterTeamRequest.predicate = [NSPredicate predicateWithFormat:[[NSString alloc] initWithFormat:@"teamNum.name = %@", self.teamToDisplay]];
    masterTeamRequest.sortDescriptors = @[[[NSSortDescriptor alloc] initWithKey:@"name" ascending:YES selector:@selector(localizedStandardCompare:)]];
    
    self.fetchedResultsController = [[NSFetchedResultsController alloc]
                                     initWithFetchRequest:masterTeamRequest
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    cell.passReceiveLbl.text = [[NSString alloc] initWithFormat:@"%ld/%ld", (long)[mtch.teleopPassed integerValue], (long)[mtch.teleopCatch integerValue]];
