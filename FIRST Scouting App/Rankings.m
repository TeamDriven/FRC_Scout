...
- (void)viewDidLoad
{
    ...
    _rankingsTableView.layer.borderColor = [[UIColor colorWithWhite:0.5 alpha:0.5] CGColor];
    _rankingsTableView.layer.borderWidth = 1;
    _rankingsTableView.layer.cornerRadius = 5;
    _rankingsTableView.separatorInset = UIEdgeInsetsMake(0, 3, 0, 3);
    
    _sortButton.titleLabel.numberOfLines = 1;
    _sortButton.titleLabel.adjustsFontSizeToFitWidth = YES;
    _sortButton.titleLabel.lineBreakMode = NSLineBreakByClipping;
    
    _sortDownBtn.alpha = 0.3;
    [_sortUpButton setImage:[UIImage imageNamed:@"BlueSortArrowUp"] forState:UIControlStateNormal];
}

-(void)viewWillAppear:(BOOL)animated{
    rankingsCDTVC = [[RankingsCDTVC alloc] init];
    [rankingsCDTVC setSortString:@"totalPointsAvg"];
    [rankingsCDTVC setRegionalSelected:regionalSelected];
    [rankingsCDTVC setManagedObjectContext:context];
    _rankingsTableView.delegate = rankingsCDTVC;
    _rankingsTableView.dataSource = rankingsCDTVC;
    
    rankingsCDTVC.tableView = _rankingsTableView;
    
    [rankingsCDTVC performFetch];
}
...
- (IBAction)sortChange:(id)sender {
    griayOutView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, 768, 1024)];
    griayOutView.backgroundColor = [UIColor colorWithWhite:0.5 alpha:0.5];
    [self.view addSubview:griayOutView];
    ...
    [griayOutView addSubview:sortersView];
    ...
    sortersView.frame = CGRectMake(_sortButton.center.x, _sortButton.center.y, 1, 1);
...
-(void)closeSorterView{
    ...
    [UIView animateWithDuration:0.2 animations:^{
        ...
        [griayOutView removeFromSuperview];
    }];
}

- (IBAction)sortUp:(id)sender {
    _sortUpButton.alpha = 1;
    [_sortUpButton setImage:[UIImage imageNamed:@"BlueSortArrowUp"] forState:UIControlStateNormal];
    _sortDownBtn.alpha = 0.3;
    [_sortDownBtn setImage:[UIImage imageNamed:@"BlackSortArrowDown"] forState:UIControlStateNormal];
    [rankingsCDTVC sortOrderLargeFirst];
}

- (IBAction)sortDown:(id)sender {
    _sortUpButton.alpha = 0.3;
    [_sortUpButton setImage:[UIImage imageNamed:@"BlackSortArrowUp"] forState:UIControlStateNormal];
    _sortDownBtn.alpha = 1;
    [_sortDownBtn setImage:[UIImage imageNamed:@"BlueSortArrowDown"] forState:UIControlStateNormal];
    [rankingsCDTVC sortOrderSmallFirst];
}

-(void)sortAutoHighHotAvg{
    [rankingsCDTVC setSortString:@"autoHighHotAvg"];
    [self sortUp:self];
    [_sortButton setTitle:@"Auto High Hot Avg" forState:UIControlStateNormal];
    [self closeSorterView];
}
-(void)sortAutoHighMissAvg{
    [rankingsCDTVC setSortString:@"autoHighMissAvg"];
    [self sortUp:self];
    [_sortButton setTitle:@"Auto High Miss Avg" forState:UIControlStateNormal];
    [self closeSorterView];
}
-(void)sortAutoHighNotAvg{
    [rankingsCDTVC setSortString:@"autoHighNotAvg"];
    [self sortUp:self];
    [_sortButton setTitle:@"Auto High Not Avg" forState:UIControlStateNormal];
    [self closeSorterView];
}
-(void)sortAutoHighMakesAvg{
    [rankingsCDTVC setSortString:@"autoHighMakesAvg"];
    [self sortUp:self];
    [_sortButton setTitle:@"Auto High Makes Avg" forState:UIControlStateNormal];
    [self closeSorterView];
}
-(void)sortAutoHighAttemptsAvg{
    [rankingsCDTVC setSortString:@"autoHighAttemptsAvg"];
    [self sortUp:self];
    [_sortButton setTitle:@"Auto High Attempts Avg" forState:UIControlStateNormal];
    [self closeSorterView];
}
-(void)sortAutoHighHotPercentage{
    [rankingsCDTVC setSortString:@"autoHighHotPercentage"];
    [self sortUp:self];
    [_sortButton setTitle:@"Auto High Hot Percent" forState:UIControlStateNormal];
    [self closeSorterView];
}
-(void)sortAutoHighAccuracyPercentage{
    [rankingsCDTVC setSortString:@"autoHighAccuracyPercentage"];
    [self sortUp:self];
    [_sortButton setTitle:@"Auto High Accuracy Percent" forState:UIControlStateNormal];
    [self closeSorterView];
}
-(void)sortAutoLowHotAvg{
    [rankingsCDTVC setSortString:@"autoLowHotAvg"];
    [self sortUp:self];
    [_sortButton setTitle:@"Auto Low Hot Avg" forState:UIControlStateNormal];
    [self closeSorterView];
}
-(void)sortAutoLowMissAvg{
    [rankingsCDTVC setSortString:@"autoLowMissAvg"];
    [self sortUp:self];
    [_sortButton setTitle:@"Auto Low Miss Avg" forState:UIControlStateNormal];
    [self closeSorterView];
}
-(void)sortAutoLowNotAvg{
    [rankingsCDTVC setSortString:@"autoLowNotAvg"];
    [self sortUp:self];
    [_sortButton setTitle:@"Auto Low Not Avg" forState:UIControlStateNormal];
    [self closeSorterView];
}
-(void)sortAutoLowMakesAvg{
    [rankingsCDTVC setSortString:@"autoLowMakesAvg"];
    [self sortUp:self];
    [_sortButton setTitle:@"Auto Low Makes Avg" forState:UIControlStateNormal];
    [self closeSorterView];
}
-(void)sortAutoLowAttemptsAvg{
    [rankingsCDTVC setSortString:@"autoLowAttemptsAvg"];
    [self sortUp:self];
    [_sortButton setTitle:@"Auto Low Attempts Avg" forState:UIControlStateNormal];
    [self closeSorterView];
}
-(void)sortAutoLowHotPercentage{
    [rankingsCDTVC setSortString:@"autoLowHotPercentage"];
    [self sortUp:self];
    [_sortButton setTitle:@"Auto Low Hot Percent" forState:UIControlStateNormal];
    [self closeSorterView];
}
-(void)sortAutoLowAccuracyPercentage{
    [rankingsCDTVC setSortString:@"autoLowAccuracyPercentage"];
    [self sortUp:self];
    [_sortButton setTitle:@"Auto Low Accuracy Percent" forState:UIControlStateNormal];
    [self closeSorterView];
}
-(void)sortAutoAccuracyPercentage{
    [rankingsCDTVC setSortString:@"autoAccuracyPercentage"];
    [self sortUp:self];
    [_sortButton setTitle:@"Auto Accuracy Percent" forState:UIControlStateNormal];
    [self closeSorterView];
}
-(void)sortMobilityBonusPercentage{
    [rankingsCDTVC setSortString:@"mobilityBonusPercentage"];
    [self sortUp:self];
    [_sortButton setTitle:@"Mobility Success Percentage" forState:UIControlStateNormal];
    [self closeSorterView];
}
-(void)sortAutonomousAvg{
    [rankingsCDTVC setSortString:@"autonomousAvg"];
    [self sortUp:self];
    [_sortButton setTitle:@"Auto Total Avg" forState:UIControlStateNormal];
    [self closeSorterView];
}

-(void)sortTeleopHighMakeAvg{
    [rankingsCDTVC setSortString:@"teleopHighMakeAvg"];
    [self sortUp:self];
    [_sortButton setTitle:@"Teleop High Make Avg" forState:UIControlStateNormal];
    [self closeSorterView];
}
-(void)sortTeleopHighMissAvg{
    [rankingsCDTVC setSortString:@"teleopHighMissAvg"];
    [self sortUp:self];
    [_sortButton setTitle:@"Teleop High Miss Avg" forState:UIControlStateNormal];
    [self closeSorterView];
}
-(void)sortTeleopHighAttemptsAvg{
    [rankingsCDTVC setSortString:@"teleopHighAttemptsAvg"];
    [self sortUp:self];
    [_sortButton setTitle:@"Teleop High Attempts" forState:UIControlStateNormal];
    [self closeSorterView];
}
-(void)sortTeleopHighAccuracyPercentage{
    [rankingsCDTVC setSortString:@"teleopHighAccuracyPercentage"];
    [self sortUp:self];
    [_sortButton setTitle:@"Teleop High Accuracy Percent" forState:UIControlStateNormal];
    [self closeSorterView];
}
-(void)sortTeleopLowMakeAvg{
    [rankingsCDTVC setSortString:@"teleopLowMakeAvg"];
    [self sortUp:self];
    [_sortButton setTitle:@"Teleop Low Make Avg" forState:UIControlStateNormal];
    [self closeSorterView];
}
-(void)sortTeleopLowMissAvg{
    [rankingsCDTVC setSortString:@"teleopLowMissAvg"];
    [self sortUp:self];
    [_sortButton setTitle:@"Teleop Low Miss Avg" forState:UIControlStateNormal];
    [self closeSorterView];
}
-(void)sortTeleopLowAttemptsAvg{
    [rankingsCDTVC setSortString:@"teleopLowAttemptsAvg"];
    [self sortUp:self];
    [_sortButton setTitle:@"Teleop Low Attempts Avg" forState:UIControlStateNormal];
    [self closeSorterView];
}
-(void)sortTeleopLowAccuracyPercentage{
    [rankingsCDTVC setSortString:@"teleopLowAccuracyPercentage"];
    [self sortUp:self];
    [_sortButton setTitle:@"Teleop Low Accuracy Percent" forState:UIControlStateNormal];
    [self closeSorterView];
}
-(void)sortTeleopAccuracyPercentage{
    [rankingsCDTVC setSortString:@"teleopAccuracyPercentage"];
    [self sortUp:self];
    [_sortButton setTitle:@"Teleop Accuracy Percent" forState:UIControlStateNormal];
    [self closeSorterView];
}
-(void)sortTeleopCatchAvg{
    [rankingsCDTVC setSortString:@"teleopCatchAvg"];
    [self sortUp:self];
    [_sortButton setTitle:@"Teleop Catch Avg" forState:UIControlStateNormal];
    [self closeSorterView];
}
-(void)sortTeleopOverAvg{
    [rankingsCDTVC setSortString:@"teleopOverAvg"];
    [self sortUp:self];
    [_sortButton setTitle:@"Teleop Over Truss Avg" forState:UIControlStateNormal];
    [self closeSorterView];
}
-(void)sortTeleopPassedAvg{
    [rankingsCDTVC setSortString:@"teleopPassedAvg"];
    [self sortUp:self];
    [_sortButton setTitle:@"Passes Avg" forState:UIControlStateNormal];
    [self closeSorterView];
}
-(void)sortTeleopReceivedAvg{
    [rankingsCDTVC setSortString:@"teleopReceivedAvg"];
    [self sortUp:self];
    [_sortButton setTitle:@"Receives Avg" forState:UIControlStateNormal];
    [self closeSorterView];
}
-(void)sortTeleopPassReceiveRatio{
    [rankingsCDTVC setSortString:@"teleopPassReceiveRatio"];
    [self sortUp:self];
    [_sortButton setTitle:@"Pass Receive Ratio" forState:UIControlStateNormal];
    [self closeSorterView];
}
-(void)sortTeleopAvg{
    [rankingsCDTVC setSortString:@"teleopAvg"];
    [self sortUp:self];
    [_sortButton setTitle:@"Teleop Total Avg" forState:UIControlStateNormal];
    [self closeSorterView];
}
...
-(void)sortTotalPointsAvg{
    [rankingsCDTVC setSortString:@"totalPointsAvg"];
    [self sortUp:self];
    [_sortButton setTitle:@"Total Points Avg" forState:UIControlStateNormal];
    [self closeSorterView];
}

-(void)sortSmallPenaltyAvg{
    [rankingsCDTVC setSortString:@"smallPenaltyAvg"];
    [self sortUp:self];
    [_sortButton setTitle:@"Small Penalty Avg" forState:UIControlStateNormal];
    [self closeSorterView];
}
-(void)sortLargePenaltyAvg{
    [rankingsCDTVC setSortString:@"largePenaltyAvg"];
    [self sortUp:self];
    [_sortButton setTitle:@"Large Penalty Avg" forState:UIControlStateNormal];
    [self closeSorterView];
}
-(void)sortPenaltyTotalAvg{
    [rankingsCDTVC setSortString:@"penaltyTotalAvg"];
    [self sortUp:self];
    [_sortButton setTitle:@"Total Penalty Avg" forState:UIControlStateNormal];
    [self closeSorterView];
}

-(void)sortOffensiveZonePercentage{
    [rankingsCDTVC setSortString:@"offensiveZonePercentage"];
    [self sortUp:self];
    [_sortButton setTitle:@"Offensive Zone Tendency" forState:UIControlStateNormal];
    [self closeSorterView];
}
-(void)sortNeutralZonePercentage{
    [rankingsCDTVC setSortString:@"neutralZonePercentage"];
    [self sortUp:self];
    [_sortButton setTitle:@"Neutral Zone Tendency" forState:UIControlStateNormal];
    [self closeSorterView];
}
-(void)sortDefensiveZonePercentage{
    [rankingsCDTVC setSortString:@"defensiveZonePercentage"];
    [self sortUp:self];
    [_sortButton setTitle:@"Defensive Zone Tendency" forState:UIControlStateNormal];
    [self closeSorterView];
}
